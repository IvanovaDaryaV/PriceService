...
* сохранение истории операций изменения цен в PostgreSQL с использованием Kafka.
...
Строки подключения и остальные секреты хранятся с использованием .NET User Secrets и не добавляются в репозиторий.

## Цели проекта

Цель проекта это практика в:
